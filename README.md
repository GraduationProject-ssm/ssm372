...
# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本高校实验室资源综合管理系统也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让医生管理信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，高校实验室资源综合管理系统的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，高校实验室资源综合管理系统是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
信息数据的处理完全依赖人工进行操作，会耗费大量的人工成本，特别是面对大量的数据信息时，传统人工操作不仅不能对数据的出错率进行保证，还容易出现各种信息资源的低利用率与低安全性问题。更有甚者，耽误大量的宝贵时间，尤其是对信息的更新，归纳与统计更是耗财耗力的过程。所以电子化信息管理的出现就能缓解以及改变传统人工方式面临的处境，一方面可以确保信息数据在短时间被高效处理，还能节省人力成本，另一方面可以确保信息数据的安全性，可靠性，并可以实现信息数据的快速检索与修改操作，这些优点是之前的旧操作模式无法比拟的。因此高校实验室资源综合管理系统为数据信息的管理模式的升级与改革提供了重要的窗口。
## 1.3 论文结构安排
...
# 4 系统设计
高校实验室资源综合管理系统的设计方案比如功能框架的设计，比如数据库的设计的好坏也就决定了该系统在开发层面是否高效，以及在系统维护层面是否容易维护和升级，因为在系统实现阶段是需要考虑用户的所有需求，要是在设计阶段没有经过全方位考虑，那么系统实现的部分也就无从下手，所以系统设计部分也是至关重要的一个环节，只有根据用户需求进行细致全面的考虑，才有希望开发出功能健全稳定的程序软件。
## 4.1 系统概要设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|8|huodong\_name|String|活动标题|是|
|9|jiaoshi\_id|Integer|发布教师|是|
|10|huodong\_types|Integer|活动类型|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|13|jiaoshi\_name|String|教师姓名|是|
|14|jiaoshi\_id\_number|String|身份证号|是|
|15|jiaoshi\_phone|String|手机号|是|
|16|jiaoshi\_email|String|邮箱|是|
|17|jiaoshi\_photo|String|照片|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|19|jieyong\_name|String|借用物品|是|
|20|jieyong\_time|Date|借用时间|是|
|21|jieyongren|String|借用人|是|
|22|insert\_time|Date|上传时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|24|news\_name|String|公告名称|是|
|25|news\_types|Integer|公告类型|是|
|26|news\_photo|String|公告图片|是|
|27|insert\_time|Date|公告时间|是|
|28|news\_content|String|公告详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|30|yonghu\_id|Integer|请假用户|是|
|31|shenhe\_types|Integer|审核状态|是|
|32|qingjia\_number|Integer|请假时间天|是|
|33|qingjia\_content|String|请假原因|是|
|34|insert\_time|Date|上传时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|36|shiyanshi\_name|String|实验室名称|是|
|37|shiyanshi\_dizhi|String|实验室地址|是|
|38|shiyanshi\_fuzeren|String|主要负责人|是|
|39|chengyuan\_content|String|主要成员|是|
|40|wupin\_content|String|基础物品|是|
|41|insert\_time|Date|上传时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|43|weixiu\_name|String|维修物品|是|
|44|jieyong\_time|Date|维修时间|是|
|45|youxing\_money|BigDecimal|维修金额|是|
|46|insert\_time|Date|上传时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|48|wuxing\_name|String|资产名称|是|
|49|wuxing\_file|String|资产下载|是|
|50|yonghu\_id|Integer|上传用户|是|
|51|shenhe\_types|Integer|审核状态|是|
|52|insert\_time|Date|上传时间|是|
...
|55|yonghu\_id\_number|String|身份证号|是|
|56|yonghu\_phone|String|手机号|是|
|57|yonghu\_email|String|邮箱|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|60|youxing\_bianhao|String|物品编号|是|
|61|youxing\_name|String|物品名称|是|
|62|youxing\_types|Integer|物品类型|是|
|63|zhuangtai\_types|Integer|物品状态|是|
|64|youxing\_money|BigDecimal|物品价格|是|
|65|youxing\_content|String|详情信息|是|
|66|insert\_time|Date|上传时间|是|
